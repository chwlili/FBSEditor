...
public partial class TemplateParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ITemplateParserVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="TemplateParser.value"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitValue([NotNull] TemplateParser.ValueContext context) { return VisitChildren(context); }
	/// <summary>
