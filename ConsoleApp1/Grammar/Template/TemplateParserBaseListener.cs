...
public partial class TemplateParserBaseListener : ITemplateParserListener {
	...
	/// <summary>
	/// Enter a parse tree produced by <see cref="TemplateParser.value"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterValue([NotNull] TemplateParser.ValueContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="TemplateParser.value"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitValue([NotNull] TemplateParser.ValueContext context) { }
	/// <summary>
