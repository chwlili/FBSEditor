...
#pragma warning restore 649
        ...
        {
            return buffer.Properties.GetOrCreateSingletonProperty<Classification>(() =>
            {
                return new Classification(this.classificationRegistry, buffer);
            });
        }
    }
    ...
    {
        private Classification classificater;

        public ClassificationErrorHandler(Classification classificater)
        {
    ...
    class ClassificationErrorListener : BaseErrorListener
    {
        ...
        public ClassificationErrorListener(Classification classification)
        {
