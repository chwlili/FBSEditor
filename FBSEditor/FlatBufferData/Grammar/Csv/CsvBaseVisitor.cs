...
public partial class CsvBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ICsvVisitor<Result> {
	...
	public virtual Result VisitCsvTab([NotNull] CsvParser.CsvTabContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitCsvRow([NotNull] CsvParser.CsvRowContext context) { return VisitChildren(context); }
	/// <summary>
