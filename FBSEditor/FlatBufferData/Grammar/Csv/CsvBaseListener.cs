...
public partial class CsvBaseListener : ICsvListener {
	...
	public virtual void EnterCsvTab([NotNull] CsvParser.CsvTabContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="CsvParser.csvTab"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitCsvTab([NotNull] CsvParser.CsvTabContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="CsvParser.csvRow"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterCsvRow([NotNull] CsvParser.CsvRowContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="CsvParser.csvRow"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitCsvRow([NotNull] CsvParser.CsvRowContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="CsvParser.csvCol"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterCsvCol([NotNull] CsvParser.CsvColContext context) { }
	/// <summary>
