...
namespace Tempalte
{
    ...
    internal class BraceMatchingProvider : IViewTaggerProvider
    {
        public ITagger<T> CreateTagger<T>(ITextView textView, ITextBuffer buffer) where T : ITag
        {
            ...
            return (new BraceMatching(textView, buffer)) as ITagger<T>;
        }
    }

    internal class BraceMatching : ITagger<TextMarkerTag>
    {
        ...
        public BraceMatching(ITextView textView, ITextBuffer buffer)
        {
