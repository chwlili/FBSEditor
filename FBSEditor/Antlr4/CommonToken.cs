...
namespace Antlr4.Runtime
{
    ...
    public class CommonToken : IWritableToken
    {
        ...
        /// </summary>
        protected internal static readonly System.Tuple<ITokenSource, ICharStream> EmptySource = System.Tuple.Create<ITokenSource, ICharStream>(null, null);
        ...
        public CommonToken(IToken oldToken)
        {
            ...
            {
                _text = oldToken.Text;
                source = System.Tuple.Create(oldToken.TokenSource, oldToken.InputStream);
            }
        }
