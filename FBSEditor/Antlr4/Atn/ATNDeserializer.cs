		...
		protected internal virtual void ReadStates(ATN atn)
		{
			...
			for (int i_1 = 0; i_1 < nstates; i_1++)
			{
				...
				if (stype == StateType.LoopEnd)
				{
					...
					loopBackStateNumbers.Add(System.Tuple.Create((LoopEndState)s, loopBackStateNumber));
				}
				else
				{
					if (s is BlockStartState)
					{
						...
						endStateNumbers.Add(System.Tuple.Create((BlockStartState)s, endStateNumber));
					}
				}
				atn.AddState(s);
			}
